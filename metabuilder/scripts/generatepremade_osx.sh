...
${MBBIN} --input metabuilder.lua --gen gnumakegcc_cygwin --metabase metabase --outdir metatmp --endstyle unix
${MBBIN} --input metabuilder.lua --gen gnumakegcc_mingw --metabase metabase --outdir metatmp --endstyle unix
${MBBIN} --input metabuilder.lua --gen gnumakegcc_posix --metabase metabase --outdir metatmp --endstyle unix

${MBBIN} --input metabuilder.lua --gen gnumakeclang_cygwin --metabase metabase --outdir metatmp --endstyle unix
${MBBIN} --input metabuilder.lua --gen gnumakeclang_mingw --metabase metabase --outdir metatmp --endstyle unix
${MBBIN} --input metabuilder.lua --gen gnumakeclang_posix --metabase metabase --outdir metatmp --endstyle unix
