...
@SET MBBIN_CIGENERATION2=%MBDIR_CIGENERATION2%\%PROJECTNAME%\%GEN%\out\%PROJECTNAME%\%PROJECTNAME%_Release.exe
@SET MBBIN_CIGENERATION3=%MBDIR_CIGENERATION3%\%PROJECTNAME%\%GEN%\out\%PROJECTNAME%\%PROJECTNAME%_Release.exe
