...
@SET MBPROGFILES=%ProgramFiles(x86)%
@IF "%MBPROGFILES%" == "" SET MBPROGFILES=%ProgramFiles%

@SET MSVCLOCATION_PRO=%MBPROGFILES%\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe
@SET MSVCLOCATION_EXPRESS1=%MBPROGFILES%\Microsoft Visual Studio 10.0\Common7\IDE\wdexpress.exe
@SET MSVCLOCATION_EXPRESS2=%MBPROGFILES%\Microsoft Visual Studio 10.0\Common7\IDE\VCExpress.exe
